export const TermsAndConditions = () => {
    return (
      <div className="container mx-auto p-6">
        ...
        Terms of use
Welcome to our Cryptoseed.com and help.Cryptoseed.com websites (the “Website(s)”). The Websites are owned and operated by Cryptoseed Ltd. (“Cryptoseed”, “we” and “our”).
Please carefully read the following terms and conditions (the “Terms” or “Terms of Use”). The Terms constitute a binding agreement between you and Cryptoseed. By entering, visiting or by using the Website in any other manner, you indicate your acceptance of these Terms. If you do not agree to these Terms, you may not access the Website or use it in any manner.

About the Website
The Website provides content and information about Cryptoseed and about the Cryptoseed mobile application (the “App”) that allows users to conveniently and securely access, send and receive cryptocurrencies, tokens and digital assets, as well as interacting with certain third party services, decentralized applications and platforms (they will all be referred to as “Third Party Services”). It also provides information regarding the Company.
The Website’s content is presented for informational purposes only. Cryptoseed does not provide any investment or financial advice whatsoever. As with any financial or investment decisions, you should conduct your own research and due diligence investigation to properly evaluate the benefits and risks of any investment or financial transaction. You should also seek the advice and guidance of qualified accountants, financial advisors, tax advisors, legal counsels and investment advisors, in connection with any investment or financial transaction.

Sponsored Services, Links
The Website may contain links to content published on other websites provided by third parties, We may also cooperate with third party providers to offer you sponsored Third Party services through the Websites. These may include, for example, Decentralized applications (dapps) (“Sponsored Services”), and receive a fee when you access or use the Sponsored Services through our links.
We do not operate or monitor these websites, their content, the Third Party Services and the Sponsored Services. You may find these websites, the Third Party Services, the Sponsored Services or the information and content contained within them objectionable or not compatible with your requirements.
We do not endorse, control or take responsibility for the linked websites, the Third Party Services, the Sponsored Services, their content, attributes, privacy practices, terms of use or any other aspect of their operation. We therefore assume no responsibility for any outcome of their use.
Use of linked websites, Third Party Services and Sponsored Services is governed by their respective terms of service, not by our Terms. When you use or access linked websites, Third Party Services or Sponsored Services, you bear the sole and exclusive responsibility for accepting and complying with their respective terms of service, fees and charges.

Intellectual Property
The intellectual property rights associated with the Website, including copyrights, trademarks, trade names, patents, trade secrets, work methods and processes, and any other right, are the sole property of Cryptoseed or its third-party licensors. These rights apply, among others, to information, articles, images, content, graphic design, data and its processing, the Website’s “look and feel”, computer code and any other detail concerning its operation.
You are not allowed to copy, duplicate, distribute, sell, make available, market and translate any information, including trademarks, images, pictures, texts and computer code from the Website, without Cryptoseed’s explicit prior and written consent.
Trademarks featured on the Website (whether registered or not) are the sole property of Cryptoseed and/or its third-party licensors. You may not use them without our prior written consent.

 

Acceptable Use of the Website
When using the Website, you must refrain from and are prohibited from:
...
Accessing or using the Website in order to develop or create a similar or competitive app, product or service.
...
Privacy
We respect your privacy. Our privacy policy is available here, and our Job Applicant Privacy Notice is available here, both are hereby incorporated by reference to and form an integral part of these Terms
...
YOU ACKNOWLEDGE AND AGREE THAT THIS WEBSITE IS BEING PROVIDED FOR USE “AS IS” AND “WITH ALL FAULTS”. YOU WILL HAVE NO PLEA, CLAIM OR DEMAND AGAINST Cryptoseed OR ITS OFFICERS, DIRECTORS, SHAREHOLDERS, EMPLOYEES, SUB-CONTRACTORS AND AGENTS (“STAFF”), IN RESPECT OF THE WEBSITE’S FEATURES, CONTENT, LIMITATIONS OR COMPATIBILITY WITH YOUR NEEDS. YOUR USE OF THE WEBSITE AND THE INFORMATION CONTAINED WITHIN THE WEBSITE, IS AT YOUR FULL AND EXCLUSIVE RISK. WE DISCLAIM ALL WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, COMPATIBILITY, SECURITY OR ACCURACY.
Cryptoseed DOES NOT WARRANT, AND HEREBY DISCLAIMS ANY WARRANTIES, EITHER EXPRESS OR IMPLIED, WITH RESPECT TO THE ACCURACY, ADEQUACY OR COMPLETENESS OF THE WEBSITE, INFORMATION AND CONTENT OBTAIND FROM THE WEBSITE OR LINKS TO OTHER WEBSITES, THIRD PARTY SERVICES AND SPONSORED SERVICES.
YOU AGREE AND ACKNOWLEDGE THAT THE USE OF THE WEBSITE IS ENTIRELY, OR AT THE MAXIMUM PERMITTED BY THE APPLICABLE LAW, AT YOUR OWN RISK. YOU HEREBY ACKNOWLEDGE AND BEAR ALL RESPONSIBILITY, RISKS, DAMAGES AND LOSS THAT MY BE RESULTED OF USING THE WEBSITE INCLUDING BUT NOT LIMITED TO ACCESSING LINKS TO USE OTHER WEBSITES, THIRD PARTY SERVICES AND SPONSORED SERVICES.
...
to the greatest extent permissible under applicable law, Cryptoseed, ITS EMPLOYEES, OR ANYONE ON ITS BEHALF SHALL NOT BE LIABLE TO YOU, FOR ANY DIRECT, INDIRECT, SPECIAL, PUNITIVE, EXEMPLARY, STATUTORY, INCIDENTAL OR CONSEQUENTIAL DAMAGE, OR ANY SIMILAR DAMAGE OR LOSS, INCLUDING LOSS OF PROFIT AND LOSS OF DATA, COSTS, EXPENSES AND PAYMENTS, EITHER IN TORT (including negligence), CONTRACT, OR IN ANY OTHER FORM OR THEORY OF LIABILITY, ARISING FROM, OR IN CONNECTION WITH THE WEBSITE, ITS CONTENT, THE USE OF, OR THE INABILITY TO USE THE WEBSITE, OR FROM ANY FAILURE, ERROR, OR BREAKDOWN IN THE FUNCTION OF THE WEBSITE, OR FROM ANY FAULT, OR ERROR MADE BY OUR STAFF, OR FROM YOUR RELIANCE ON CONTENT AVAILABLE ON OR THROUGH THE WEBSITE or through the linked websites, THIRD PARTY SERVICES AND SPONSORED SERVICES, OR FROM ANY COMMUNICATION WITH Cryptoseed, OR FROM RETENTION, DELETION, DISCLOSURE AND ANY OTHER USE OR LOSS OF CONTENT OR INFORMATION.
...
From time to time, Cryptoseed may change these Terms. Changes will take effect 7 days after their initial posting on the Website, unless Cryptoseed amends the Terms to comply with legal requirements. In such cases, the amendments will become effective immediately upon their initial posting, or as required. at

Contact Us
You may contact us with any questions or comments, through the Website contact form, the Website online chat, or at: help@Cryptoseed.com.
