    ...
    <div className="home-container">
      ...
      <section className="about-section">
        <div className="about-content">
          ...
          <p>En El Gato Negro, creamos productos únicos con ingredientes de la más alta calidad, comprometidos con el medio ambiente.</p>
        </div>
      </section>

      {/* Features Section */}
      <section className="features-section">
        <h3>Nuestras Promesas</h3>
        <div className="features-grid">
          <div className="feature">
            <h4>Calidad</h4>
            <p>Ingredientes premium para una experiencia única.</p>
          </div>
          <div className="feature">
            <h4>Compre Local</h4>
            <p>Apoya la economía local eligiendo productos nacionales.</p>
          </div>
          <div className="feature">
            <h4>Cuidado Ambiental</h4>
            <p>Promovemos el uso de productos reparables y sostenibles.</p>
          </div>
        </div>
      </section>
