  ...
  return (
    <nav className="navbar bg-body-tertiary fixed-top ">
      <div className="container-fluid">
        ...
        {Location.pathname === "/admin/Orders" || Location.pathname === "/admin/CreateProduct" ? null : (
          ...
          <div className="offcanvas-body">
            <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
              <li className="nav-item">
                <Link style={{ textDecoration: "none" }} className="nav-link" to="/admin/users">
                  <BsFillPeopleFill /> Users
                </Link>
              </li>
              <li className="nav-item">
                <Link style={{ textDecoration: "none" }} className="nav-link" to="/admin/Products">
                  <MdProductionQuantityLimits /> Products
                </Link>
              </li>
              <li className="nav-item">
                <Link style={{ textDecoration: "none" }} className="nav-link" to="/admin/Orders">
                  <BsBorderStyle /> Orders
                </Link>
              </li>
              <li className="nav-item">
                <Link style={{ textDecoration: "none" }} className="nav-link" to="/admin/CreateProduct">
                  <IoIosCreate /> Create Product
                </Link>
              </li>
              <li className="nav-item">
                <Link style={{ textDecoration: "none" }} className="nav-link" to="/Profile">
                  <AiFillSetting /> Settings
                </Link>
              </li>
              <li className="nav-item">
                <button style={{ textDecoration: "none", background: "none", border: "none" }} className="nav-link" onClick={(e) => CerrarSes(e)}>
            ...
            <div className="footerContainer">
              <div className="ContImage">
                <img
                  src={UserAdmin?.image ? UserAdmin?.image : "https://cdn-icons-png.flaticon.com/512/3135/3135768.png"}
                  alt="admin"
                />
              </div>
              <div className="Contname">
                <span>EL GATO NEGRO</span>
              </div>
            </div>
          </div>
        </div>
...
// export function NavAdmin({handleClick, handleSubmit, handleInputChange, name}) {
//   const UserAdmin = useSelector((state) => state.userActive);
//   //const UserAdmin = JSON.parse(localStorage.getItem("USUARIO")) || []; quitamos esto
//   const Location = useLocation()
//   const navigate = useNavigate();
//   const dispatch = useDispatch()
